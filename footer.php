<footer class="footerWrap footerStyleDark">
							...
							<aside class="columns1_4 widgetWrap widget widget_text">
								...
								<div class="textwidget">
									<figure class="sc_image  sc_image_shape_square">
										<img src="images/logo/logo_81x73.png" alt=""/>
									</figure>
									<br/> 263 Barkly Street, Footscray, Victoria 3011
									<br/> info@sumsigns.com.au
									<br/> 0426 874 908
								</div>
							</aside>
				...
				<div class="copyWrap">
					<div class="copy main">
						<div class="copyright">
							<a href="#">Sumsigns</a>&copy; 2015 All Rights Reserved
						...
						<div class="copy_socials socPage">
							<ul>
								<li>
									<a class="social_icons icon-facebook" target="_blank" href="https://www.facebook.com/sumbright"> </a>
								</li>
								<li>
