...
<body class="home page fullscreen top_panel_above sidemenu_left usermenu_hide">
										...
										<div class="wpb_column vc_column_container vc_col-sm-12">
											<div class="wpb_wrapper">
												<div class="sc_content main">
													<div class="columnsWrap column_block sc_columns sc_columns_count_2">
														<div class="columns1_2 sc_column_item sc_column_item_1 odd first">
															<div id="sc_googlemap_2061796807" class="sc_googlemap sc_googlemap_style_2" data-address="263 Barkly Street Footscray, Victoria 3011" data-latlng="" data-zoom="16" data-style="default" data-point="" data-description="San Francisco, CA 94102, US" ></div>
														</div>
														<div class="columns1_2 sc_column_item sc_column_item_2 even">
															<h2 class="sc_title sc_title_regular" style="text-align:left;">We Would Love To Hear From You</h2>
															<div class="wpb_text_column wpb_content_element ">
																<div class="wpb_wrapper">
																	<p>Lorem ipsum dolor sit amet, has facer euismod hendrerit cu. Ei zril aliquid iudicabit has, et duo tollit oportere. Ex eos admodum accumsan prodesset, vel ex accusam accusamus. Zril integre voluptua vis ea, labore conclusionemque te vim. Ei suas vivendum neglegentur vel, ipsum aliquam has ne.<br />
																	Nulla facilisi. Phasellus auctor tortor in libero fermentum, at fringilla lectus porta. In hac habitasse platea dictumst. Aenean tristique ante a enim aliquam eleifend. Sed auctor et elit at blandit.</p>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="columnsWrap sc_columns sc_columns_count_3 margin_top_small">
														...
														<div class="columns1_3 sc_column_item sc_column_item_3 odd after_span_2">
															<h2 class="sc_title sc_title_regular" style="text-align:left;">Business hours</h2>
															<div class="wpb_text_column wpb_content_element ">
																<div class="wpb_wrapper">
																	<p class="big_text">
